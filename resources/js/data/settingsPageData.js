...
export const personalInfoRows = [
  ...
  { label: "Deactivate account", value: "", action: "Deactivate", danger: true },
];

export const notificationRows = {
  buyer: [
    { id: "inboxMessages", label: "Inbox messages", email: true, push: true },
    { id: "orderMessages", label: "Order messages", email: true, push: true },
    { id: "orderUpdates", label: "Order updates", email: true, push: true },
    { id: "ratingReminders", label: "Rating reminders", email: true, push: true },
    { id: "buyerBriefs", label: "Buyer briefs", email: true, push: true },
    { id: "accountUpdates", label: "Account updates", email: false, push: true },
    { id: "savedServices", label: "Saved service updates", email: false, push: true },
  ...
  seller: [
    ...
    { id: "payouts", label: "Payout and tax updates", email: true, push: false },
  ],
};
...
export const securityRows = [
  {
    ...
    description: "Your phone is verified with BDGigs. Edit it when your number changes.",
    action: "Edit",
  },
  {
    title: "Security question",
    description: "Add another protection layer for withdrawals, password changes, and sensitive account updates.",
    action: "Edit",
  },
];
