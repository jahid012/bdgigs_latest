...
export const aiGigDetail = {
  ...
  breadcrumbs: ["Programming & Tech", "AI Development", "AI Websites & Software"],
  relatedTags: ["Ai chatbot", "Ai developer", "Full stack website", "Ai website", "Ai software"],
  seller: {
    ...
    bio:
      "At Wiznic Solution, we specialize in AI-powered development, chatbot integration, and custom web/app solutions. From GPT-based assistants to automation tools and full-stack websites, we deliver smart, scalable systems tailored to your business.",
  },
  gallery: [
  ...
  packages: [
    {
      ...
      description: "Develop a simple AI website with Basic, smooth functionality & User Authentication.",
      features: {
    ...
    },
    {
      ...
      revisions: "Unlimited Revisions",
      description: "Develop an Advanced AI web or App with your specific features tailored to your needs.",
      features: {
        "Functional Web App": true,
        "Desktop Application": false,
        "Integration of an AI model to existing app": true,
    ...
    },
    {
      ...
      revisions: "Unlimited Revisions",
      description: "Develop premium, complete AI-powered app or web app with Database Storing, Fine-tuning + Deployment.",
      features: {
        "Functional Web App": true,
  ...
  about: {
    heading: "Transform Your AI Vision into a Powerful, High Performing Website or Software",
    paragraphs: [
    ...
    why: ["Proven experience in AI & full-stack development", "Clean, scalable, and maintainable code", "Fully responsive across all devices"],
    closing: "Send me a message now and lets get started!!!",
  },
  specs: [
    { label: "Application Type", value: "Web Application" },
    { label: "Desktop Frameworks", value: "Windows Presentation Foundation (WPF), React Native for Web, Flutter for Desktop" },
    { label: "AI Type", value: "Chat, Shopping, Booking, Restaurant, Health & Fitness, Education, Social Networking, Ecommerce, Custom, Real Estate" },
    { label: "Programming Language", value: "Dart, Java, JavaScript, Python, TypeScript, React" },
    { label: "Web Frameworks", value: "React, Angular, Vue.js, Express.js (Node.js), Django, Flask, Ruby on Rails, Next.js" },
    { label: "No & Low-Code Builders", value: "Lovable, FlutterFlow, Webflow" },
  ],
  portfolio: {
    title: "DO5 Steel Estimator Web Platform",
    date: "From: March 2025",
    description: "DO5 Estimator - AI-Powered Steel Fabrication Estimation Tool Description:",
    image: "/assets/img/gig_images/21.png",
    tags: ["Edilizia", "+12"],
    cost: "$1000-$2500",
    duration: "7-30 days",
    thumbnails: ["/assets/img/gig_images/21.png", "/assets/img/gig_images/20.png", "/assets/img/gig_images/11.png", "/assets/img/gig_images/12.png", "/assets/img/gig_images/13.png"],
  },
  faq: [
    { question: "What's the process to get started?", answer: "Share your idea, required features, timeline, and any references. I will map the scope and recommend the right package." },
    { question: "What is your development process?", answer: "I start with requirements, create a clear technical plan, build in milestones, test the app, and then deliver with support." },
    { question: "Can you integrate AI features into my existing app or website?", answer: "Yes. I can integrate chatbots, AI assistants, recommendation flows, automation, and model connections into existing products." },
    { question: "How do you ensure data privacy and security?", answer: "I follow secure coding practices, use protected keys, validate input, and can align the build with your preferred hosting and privacy requirements." },
    { question: "How do you ensure client satisfaction for completed work?", answer: "I keep scope transparent, provide updates, include revisions, and hand over source code when included in the package." },
  ],
  reviews: {
    count: 36,
    rating: 4.8,
...
function createDetailFromListingGig(gig) {
  return {
    ...
    id: gig.id,
    title: gig.title,
    breadcrumbs: ["Programming & Tech", gig.categoryLabel, "Freelance Services"],
    seller: {
      ...aiGigDetail.seller,
      name: gig.seller,
      level: gig.level,
    ...
    gallery: [gig.image, ...aiGigDetail.gallery.filter((image) => image !== gig.image)].slice(0, 6),
