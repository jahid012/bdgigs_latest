...
export const categories = [
    {
        ...
        description:
            "Logos, brand systems, social assets, packaging, presentations, and polished visual identities.",
        count: "8,200+",
    ...
    },
    {
        ...
        description:
            "Websites, apps, automations, dashboards, integrations, bug fixes, and technical consulting.",
        count: "9,500+",
    ...
    },
    {
        ...
        description:
            "SEO, paid ads, content strategy, email funnels, analytics, and campaign management.",
        count: "7,100+",
    ...
    },
    {
        ...
        description:
            "Explainers, motion graphics, reels, product demos, editing, and launch videos.",
        count: "6,750+",
    ...
    },
    {
        ...
        description:
            "Website copy, articles, product descriptions, scripts, proofreading, and localization.",
        count: "5,900+",
    ...
    },
    {
        ...
        title: "AI Services",
        description:
            "Prompt systems, AI agents, workflow automation, model integrations, and custom chat tools.",
        count: "4,300+",
...
export const processSteps = [
    ...
    },
    {
        ...
        description:
            "Track progress, request revisions, and approve polished work only when the final delivery is ready.",
