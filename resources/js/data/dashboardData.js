export const sidebarItems = [
  ...
  { label: "Saved Services", icon: "heart", path: "/dashboard/saved-services" },
...
export const sellerSidebarItems = [
  { label: "Overview", icon: "dashboard", path: "/dashboard/seller", end: true },
  { label: "Orders", icon: "orders", path: "/dashboard/seller/orders" },
  { label: "Messages", icon: "message", path: "/dashboard/seller/messages" },
  { label: "My Services", icon: "packageCheck", path: "/dashboard/seller/services" },
  { label: "Earnings", icon: "payment", path: "/dashboard/seller/earnings" },
  { label: "Seller Profile", icon: "user", path: "/dashboard/seller/profile" },
  { label: "Settings", icon: "settings", path: "/dashboard/seller/settings" },
];

export const stats = [
  { label: "Active Orders", value: "8", trend: "+2 this week", icon: "orders" },
  { label: "Completed Jobs", value: "42", trend: "96% success", icon: "packageCheck" },
  { label: "Total Spent", value: "$8.4k", trend: "On budget", icon: "payment" },
  { label: "Saved Services", value: "19", trend: "5 new", icon: "heart" },
];

export const sellerStats = [
  { label: "Active Orders", value: "14", trend: "+4 this week", icon: "orders" },
  { label: "Completed Jobs", value: "186", trend: "98% success", icon: "packageCheck" },
  { label: "Monthly Revenue", value: "$5.4k", trend: "+18% growth", icon: "payment" },
  { label: "Unread Messages", value: "9", trend: "3 priority", icon: "message" },
];
...
export const buyerOrderInsights = [
  { label: "Next delivery", value: "May 8", detail: "SEO audit from Ayesha K." },
  { label: "In review", value: "2", detail: "Landing page and content audit" },
  { label: "Protected spend", value: "$1.2k", detail: "Held safely until approval" },
];

export const sellerOrderInsights = [
  { label: "Next milestone", value: "Today", detail: "CloudPeak wireframe review" },
  { label: "Pending revisions", value: "2", detail: "BrightCart and LaunchNest" },
  { label: "Ready to clear", value: "$1.5k", detail: "Projected from active orders" },
];
...
export const sellerMessages = [
  ...
  },
  {
    initials: "NC",
    name: "Northstar CRM",
    message: "We approved the final files. Thank you for the clean handoff.",
    time: "Yesterday",
  },
];
...
export const buyerMessageThreads = [
  {
    ...
    messages: [
      { from: "Nadia R.", text: "I uploaded the revised hero section for review.", time: "10:32 AM", own: false },
      { from: "Jahid", text: "Great. I will check the mobile spacing and send notes today.", time: "10:38 AM", own: true },
      { from: "Nadia R.", text: "Perfect. I also added a cleaner CTA state for the pricing block.", time: "10:41 AM", own: false },
    ],
  },
  {
    id: "buyer-thread-2",
    ...
    messages: [
      { from: "Ayesha K.", text: "The SEO audit summary is ready in the order thread.", time: "9:18 AM", own: false },
      { from: "Jahid", text: "Thanks. I will review the keyword map and confirm the next batch.", time: "9:45 AM", own: true },
    ],
  },
  {
    id: "buyer-thread-3",
    ...
    messages: [
      { from: "Daniel S.", text: "I can connect the assistant to your CRM next.", time: "Yesterday", own: false },
      { from: "Jahid", text: "That sounds useful. Please send a scope for the integration.", time: "Yesterday", own: true },
    ],
  },
  {
    id: "buyer-thread-4",
    ...
    messages: [
      { from: "Lina P.", text: "The project has been closed and payment was released back.", time: "Apr 25", own: false },
    ],
  },
];
...
export const sellerMessageThreads = [
  {
    ...
    messages: [
      { from: "CloudPeak Labs", text: "Can we review the pricing block before the next milestone?", time: "10:48 AM", own: false },
      { from: "Jahid", text: "Yes. I can send an updated comparison layout in the next delivery.", time: "10:51 AM", own: true },
      { from: "CloudPeak Labs", text: "Great. Please keep the annual plan most prominent.", time: "10:53 AM", own: false },
    ],
  },
  {
    id: "seller-thread-2",
    ...
    messages: [
      { from: "BrightCart", text: "The delivered screens look great. I added two notes.", time: "10:12 AM", own: false },
      { from: "Jahid", text: "Thanks. I will clean up the empty states and upload the updated file.", time: "10:22 AM", own: true },
    ],
  },
  {
    id: "seller-thread-3",
    ...
    unread: 0,
    priority: "Approved",
    preview: "We approved the final files. Thank you for the clean handoff.",
    messages: [
      { from: "Northstar CRM", text: "We approved the final files. Thank you for the clean handoff.", time: "Yesterday", own: false },
      { from: "Jahid", text: "Happy to help. I included the final style guide in the delivery folder.", time: "Yesterday", own: true },
    ],
  },
  {
    id: "seller-thread-4",
    ...
    preview: "We are collecting the brand references and will share them soon.",
    messages: [
      { from: "LaunchNest", text: "We are collecting the brand references and will share them soon.", time: "May 6", own: false },
    ],
  },
];
