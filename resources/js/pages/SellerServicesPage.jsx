...
function SellerServicesPage({ onNavigate }) {
  ...
  return (
    <DetailPageShell content={content} onNavigate={onNavigate} variant="seller">
      <MinimalServiceList content={content} onNavigate={onNavigate} seller services={sellerServices} />
    </DetailPageShell>
  );
}
