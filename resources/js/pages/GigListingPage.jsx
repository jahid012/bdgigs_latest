...
function GigListingPage({ onNavigate }) {
    ...
    const firstOrderGigs = useMemo(
        () => scopedGigs.filter((gig) => gig.featured).slice(0, 4),
        [scopedGigs],
    );
        ...
        <div className="listing-page">
            ...
            <main className="listing-main">
                <div className="container">
                    ...
                    {!isSearchPage ? (
                        <CategoryChipRail
                            chips={pageMeta.chips}
                            selectedOptions={filters.serviceOptions}
                            onToggle={toggleCategoryChip}
                        />
                    ) : null}
                    ...
                    <section
                        ...
                        aria-label={t(
                            "pages.giglistingpage.gigFiltersAndSorting",
                        )}
                    >
                        <div className="listing-filter-row" ref={filterRef}>
                            <div className="listing-filter-buttons">
                                {activeButtons.map((panel) => (
                                    <div
                                        className="listing-filter-group"
                                        key={panel}
                                    >
                                        <button
                        ...
                        <div className="listing-result-row">
                            ...
                            <label className="listing-sort">
                                <span>{t("pages.giglistingpage.sortBy")}</span>
                                <select
                                    value={filters.sort}
                                    onChange={(event) =>
                                        setFilters((current) => ({
                    ...
                    {isSearchPage && firstOrderGigs.length ? (
                        <section
                            className="first-order-panel"
                            aria-labelledby="firstOrderTitle"
                        >
                            <div className="first-order-heading">
                                <span
                                    className="first-order-icon"
                                    aria-hidden="true"
                                >
                                    <Icon name="packageCheck" />
                                </span>
                                <div>
                                    <h2 id="firstOrderTitle">
                                        {t(
                                            "pages.giglistingpage.topFreelancersForYourFirstOrder",
                                        )}
                                    </h2>
                                    <p>
                                        {t(
                                            "pages.giglistingpage.discoverSellersWithAGreatTrackRecordIn",
                                        )}
                                    </p>
                                </div>
                            </div>
                    ...
                    {filteredGigs.length ? (
                        ...
                        <div className="listing-empty-state">
                            ...
                            <h2>
                                {t(
                                    "pages.giglistingpage.noGigsMatchTheseFilters",
                                )}
                            </h2>
                            <p>
                                {t(
                                    "pages.giglistingpage.clearOneOrTwoFiltersToBringMore",
                                )}
                            </p>
                            <button
                                type="button"
                            ...
                            >
                                {" "}
                                {t("pages.giglistingpage.clearFilters")}{" "}
                            </button>
                        </div>
                    )}
                </div>
                ...
                <ListingBottomSections
                    historyGigs={listingGigs.slice(
                        0,
                        isHistoryExpanded ? 12 : 8,
                    )}
                    ...
                    onToggleHistory={() =>
                        setIsHistoryExpanded((expanded) => !expanded)
                    }
                />
            </main>
...
function ListingPagination({ activePage, onPageChange }) {
    ...
    return (
        <nav
            ...
            aria-label={t("pages.giglistingpage.gigResultsPagination")}
        >
            <button
                type="button"
                aria-label={t("pages.giglistingpage.previousPage")}
            ...
            <button
                type="button"
                aria-label={t("pages.giglistingpage.nextPage")}
                onClick={() => changePage(activePage + 1)}
            >
                <Icon name="arrowRight" />
            </button>
...
function ListingBottomSections({
    ...
    return (
        <section
            className="listing-bottom-surface"
            aria-label={t("pages.giglistingpage.moreWaysToHire")}
        >
            <div className="container">
                {!isHistoryHidden ? (
                    <section
                        className="browsing-history-section"
                        aria-labelledby="browsingHistoryTitle"
                    >
                        <div className="listing-bottom-heading">
                            <h2 id="browsingHistoryTitle">
                                {t("pages.giglistingpage.yourBrowsingHistory")}
                            </h2>
                            <div className="browsing-history-actions">
                                <button type="button" onClick={onClearHistory}>
                                    {" "}
                                    {t("pages.giglistingpage.clearAll")}{" "}
                                </button>
                                ...
                                <button
                                    type="button"
                                    aria-label={t(
                                        "pages.giglistingpage.scrollHistoryLeft",
                                    )}
                                    onClick={() => onScrollHistory(-1)}
                                >
                                    <Icon name="arrowRight" />
                                </button>
                                <button
                                    type="button"
                                    aria-label={t(
                                        "pages.giglistingpage.scrollHistoryRight",
                                    )}
                                    onClick={() => onScrollHistory(1)}
                                >
                                    <Icon name="arrowRight" />
                ...
                <section
                    className="talent-way-section"
                    aria-labelledby="talentWayTitle"
                >
                    <h2 id="talentWayTitle">
                        {t("pages.giglistingpage.findFreelanceTalentYourWay")}
                    </h2>
                    <div className="talent-way-grid">
                        <TalentWayCard
                            ...
                            onClick={() =>
                                onNavigate(
                                    "/search/gigs?query=project%20brief&source=talent-way",
                                )
                            }
                            title={t("pages.giglistingpage.postAProjectBrief")}
                        />
                        <TalentWayCard
                            action="Get started"
                            ...
                            onClick={() =>
                                onNavigate(
                                    "/search/gigs?query=expert%20sourcing&source=talent-way",
                                )
                            }
                            title={t(
                                "pages.giglistingpage.letUsFindYourFreelancer",
                            )}
                        />
                        <TalentWayCard
                            ...
                            onClick={() =>
                                onNavigate(
                                    "/search/gigs?query=freelance%20team&source=talent-way",
                                )
                            }
                            title={t(
                                "pages.giglistingpage.getATeamBuiltForYou",
                            )}
                        />
                    </div>
                </section>
    ...
    return (
        <header className="listing-category-heading">
            <nav
                ...
                aria-label={t("pages.giglistingpage.breadcrumb")}
            >
                <button
                    type="button"
                    aria-label={t("pages.giglistingpage.goToHomePage")}
            ...
            <div className="listing-heading-row">
                <div>
                    ...
                    <p>
                        ...
                        <a
                            href="#how-bdgigs-works"
                            onClick={(event) => event.preventDefault()}
                        >
                            <Icon name="play" />{" "}
                            {t("pages.giglistingpage.howBdgigsWorks")}{" "}
                        </a>
                    </p>
                </div>
            </div>
...
function CategoryChipRail({ chips, selectedOptions, onToggle }) {
    ...
    return (
        <section
            className="category-chip-section"
            aria-label={t(
                "pages.giglistingpage.websiteDevelopmentServiceTypes",
            )}
        >
                ...
                {chips.map((chip) => {
                    ...
                    return (
                        <button
                            ...
                            key={chip.label}
                            onClick={() => onToggle(chip.optionId)}
                        >
                            <span
...
function FilterPopover({
    ...
    return (
        <div
            className={`listing-filter-popover ${panel}`}
            role="dialog"
            aria-label={`${filterButtonLabels[panel]} filters`}
        >
            ...
            <div className="listing-filter-footer">
                <button type="button" onClick={onClear}>
                    {" "}
                    {t("pages.giglistingpage.clearAll2")}{" "}
                </button>
                <button type="button" onClick={onApply}>
                    {" "}
                    {t("pages.giglistingpage.apply")}{" "}
                </button>
            </div>
        </div>
    );
                    ...
                    <button
                        ...
                        onClick={() =>
                            setDraftFilters((current) => ({
                                ...current,
                                category:
                                    item.id === "all-categories" ? "" : item.id,
                            }))
                        }
                    >
                        <span aria-hidden="true"></span>
                ...
                <section className="listing-filter-section" key={section.title}>
                    ...
                    <div className="listing-filter-options">
                        {section.options.map((option) => {
                            const checked = draftFilters[field].includes(
                                option.id,
                            );
                            return (
                                <label
                                    className="listing-checkbox-option"
                                    key={option.id}
                                >
                                    <input
                                        type="checkbox"
                    ...
                    {section.more ? (
                        <button className="listing-more-filter" type="button">
                            {section.more}
                        </button>
                    ) : null}
                </section>
...
function BudgetFilter({ draftFilters, setDraftFilters }) {
    ...
    return (
        <section className="budget-filter">
            <label>
                <span>{t("pages.giglistingpage.upTo")}</span>
                <strong>
                    $
                    <input
                        type="number"
                        ...
                        aria-label={t("pages.giglistingpage.maximumBudget")}
                    />
                </strong>
            </label>
        </section>
...
function DeliveryFilter({ draftFilters, setDraftFilters }) {
    ...
    return (
        <section className="listing-filter-section delivery-filter">
            <h3>{t("pages.giglistingpage.deliveryTime")}</h3>
    ...
    return (
        <article className="gig-listing-card">
            <div className="gig-listing-media">
                <Link
                    className="gig-listing-image-link"
                    to={`/gigs/${gig.id}`}
            ...
            <div className="gig-listing-body">
                ...
                {gig.consultation ? (
                    <p className="gig-consultation">
                        <Icon name="video" />{" "}
                        {t(
                            "pages.giglistingpage.offersVideoConsultations",
                        )}{" "}
                    </p>
                ) : null}
            </div>
...
function getPageMeta(pathname, query, isSearchPage) {
    ...
    return {
        ...
        title: isWebsiteDevelopment
            ? websiteCategoryPage.title
        ...
        resultLabel: isWebsiteDevelopment
...
function getScopedGigs({ isSearchPage, query, pathname }) {
    if (isSearchPage) {
        ...
        const matches = listingGigs.filter((gig) =>
            [gig.title, gig.seller, gig.categoryLabel, gig.searchText]
                .join(" ")
                .toLowerCase()
    ...
    const titleSlug =
        pathname.split("/").filter(Boolean)[2] || "website-development";
...
function applyFilters(gigs, filters) {
    return gigs.filter((gig) => {
        if (filters.category && gig.categoryId !== filters.category)
            return false;
        if (
        ...
        if (
            ...
            return false;
        if (filters.maxBudget && gig.price > Number(filters.maxBudget))
            return false;
        if (filters.deliveryTime) {
            const delivery = deliveryOptions.find(
                (option) => option.id === filters.deliveryTime,
            );
...
function clearFilterGroup(filters, panel) {
    ...
    if (panel === "serviceOptions")
        return {
            ...filters,
            serviceOptions: [],
        };
    if (panel === "sellerDetails")
        return {
            ...filters,
            sellerDetails: [],
        };
